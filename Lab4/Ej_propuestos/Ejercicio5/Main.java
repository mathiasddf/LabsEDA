 ...
 * de LinkedList<Integer> (lista simplemente enlazada genérica).
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("==== LISTA SIMPLEMENTE ENLAZADA (1–10) ====");
        do {
            System.out.println("\nMenú de opciones:");
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    boolean eliminadoPorClave = lista.deleteByKey(clave);
                    if (eliminadoPorClave) {
                ...
                case 5:
                    ...
                    int pos = sc.nextInt();
                    boolean eliminadoPorPos = lista.deleteAtPosition(pos);
                    if (eliminadoPorPos) {
                        System.out.println("Nodo en posición " + pos + " eliminado.");
                    } else {
