 ...
 * de LinkedList<Integer> (lista circular simple genérica).
 * Inicialmente, la lista contiene los elementos 1..12.
 */
public class Main {
    public static void main(String[] args) {
        ...
        // Pre-cargar la lista con los enteros del 1 al 12
        for (int i = 1; i <= 12; i++) {
            lista.addLast(i);
        }

        System.out.println("==== LISTA CIRCULAR (1–12) ====");
        do {
            System.out.println("\nMenú de opciones:");
